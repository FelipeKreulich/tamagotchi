...
const dict: Dictionary = {
  ...
  photobooth: {
    title: "📸 PHOTOBOOTH",
    subtitle: "Carrega em partilhar ou transferir o PNG.",
    share: "PARTILHAR",
    shareTitle: "O meu Tamagotchi",
    shareFailed: "Falhou a partilhar.",
    download: "TRANSFERIR",
    downloaded: "📥 PNG guardado!",
    tagline: "TAMA-GOTCHI",
    ageLabel: "IDADE",
    stageLabel: "FASE",
    moodLabel: "HUMOR",
  ...
  shop: {
    ...
    items: {
      ...
      btnRetro: "RETRO",
      btnDark: "SOMBRIO",
      palVirtualBoy: "VIRTUAL BOY",
      palAmber: "AMBAR",
      palBlueberry: "MIRTILO",
      palMidnight: "MEIA-NOITE",
      caseFlamingo: "FLAMINGO",
      caseChrome: "CROMO",
      caseWood: "MADEIRA",
      caseClear: "CRISTAL",
      wpDots: "PONTOS",
